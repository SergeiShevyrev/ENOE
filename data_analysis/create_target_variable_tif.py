...
for file in os.listdir('out'):         #exclude 3band tif files
    if (file.lower().endswith("."+'tif'.lower()) and file.lower().startswith('prox') and not file==os.path.basename(proximity_total)) or (file.lower().endswith("."+'tif'.lower()) and file.lower().startswith('out')):
        print('removing ', file)
